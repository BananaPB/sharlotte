...
class IngredientCategorySeeder extends Seeder
{
    ...
    private const CATEGORIES = [
        ['code' => 'fruits', 'label_fr' => 'Fruits', 'description_fr' => 'Fruits frais, congelés, en boite. Crus comme cuits.'],
        ['code' => 'vegetables', 'label_fr' => 'Légumes', 'description_fr' => 'Légumes frais, congelés, en boite. Crus comme cuits.'],
        ...
        ['code' => 'baking_cooking_aids', 'label_fr' => 'Aides à la cuisine, pâtisserie & boulangerie', 'description_fr' => 'Levures, poudres, décorations commestibles, pâtes préemballées etc.'],
